<div wire:poll="refreshComponent" class="flex justify-center p-8">
    ...
    <div class="flex space-x-6 w-full max-w-7xl">
        ...
        <div class="w-1/4 bg-white shadow-md rounded-lg p-4">
            ...
            <livewire:tickets.count-percentage :progress="$newPrcntg" />
        ...
        <div class="w-1/4 bg-white shadow-md rounded-lg p-4">
            ...
            <p class="font-semibold bg-orange-100 px-2 py-1 rounded text-lg mb-4">Count : {{$newCount}}</p>
        ...
        <div class="w-1/4 bg-white shadow-md rounded-lg p-4">
            ...
            <p class="font-semibold bg-red-100 px-2 py-1 rounded text-lg mb-4">Count : {{$newCount}}</p>
        ...
        <div class="w-1/4 bg-white shadow-md rounded-lg p-4">
            ...
            <p class="font-semibold bg-green-100 px-2 py-1 rounded text-lg mb-4">Count : {{$newCount}}</p>
