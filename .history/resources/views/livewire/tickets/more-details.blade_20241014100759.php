<div>
    <div class="p-6 bg-white rounded-lg shadow-md space-y-6">
        ...
        <div class="flex justify-between mt-8">
            ...
            <div>
                <button type="button" wire:click="changeStatus" class="text-Green-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Start {{$ticketId}}</button>
