<div wire:poll="refreshComponent" class="flex justify-center p-8 h-screen">
    ...
    <div class="flex flex-wrap space-x-6 w-full max-w-7xl h-full">   

        <div class="w-1/4 sm:w-1/2 md:w-1/4 bg-white shadow-md rounded-lg p-4 h-full">
            ...
            <div class="space-y-4 h-2/3  overflow-y-auto ">
                ...
                <div class=" bg-yellow-100 rounded-md p-4">
                    ...
                    <div  wire:click="$emit('openModal', 'tickets.more-details', {{ json_encode(['ticket' => $nw->id]) }})" class="text-sm text-gray-400 flex justify-between">
                        <div class="flex">
                            <svg class="w-4 h-4 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                    ...
                    <div class="flex justify-between items-center mt-4 text-sm">
                        <button class="flex items-center" wire:click="$emit('openModal', 'tickets.more-details', {{ json_encode(['ticket' => $nw->id]) }})"><svg class="w-4 h-4 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="none" viewBox="0 0 24 24">
                        ...
                        <button class="flex items-center"><svg class="w-4 h-4 text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor">
                        ...
                        <button class="flex items-center"><svg class="w-4 h-4 text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
