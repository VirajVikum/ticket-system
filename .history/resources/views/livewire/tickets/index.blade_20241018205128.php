...
<div wire:poll="refreshComponent" class="flex justify-center p-8 h-5/6">
    ...
    <div class="flex space-x-6 w-full max-w-7xl h-full">
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 bg-white shadow-md rounded-lg p-4 h-full"> 
            <livewire:tickets.count-percentage-charts.new-ticket />
        
            <p class="font-semibold bg-yellow-100 px-2 py-1 rounded text-lg mb-4">
                Count : {{ $newCount }}
            </p>
                        ...
                        <div class="flex justify-between items-center mt-4 text-sm">
                            ...
                            <button class="flex items-center">
                                <svg class="w-4 h-4 text-gray-600" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path
                                        d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07ZM13 8.57 8.57 13 7 11.43 11.43 7 13 8.57Z">
                                    </path>
                                </svg> Resolve
                            </button>
                        </div>
