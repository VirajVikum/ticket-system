    ...
    <div class="flex space-x-6 w-full max-w-7xl">
        ...
        <div class="w-1/4 bg-white shadow-md rounded-lg p-4">
            ...
            <div class=" bg-white shadow-lg rounded-lg p-4 text-center">
                <h3 class="text-gray-700 font-bold mb-2">Abandon %</h3>
                <div class="relative">
                  <svg class="w-full h-32" viewBox="0 0 100 50">
                    <!-- Background gray arc -->
                    <path d="M 10,40 A 35,35 0 0,1 90,40" fill="none" stroke="#e5e7eb" stroke-width="10" />
                    <!-- Green progress arc -->
                    <path d="M 10,40 A 35,35 0 0,1 30,35" fill="none" stroke="#10b981" stroke-width="10" />
                    <!-- Indicator line -->
                    <line x1="50" y1="40" x2="30" y2="35" stroke="#10b981" stroke-width="2" />
                  </svg>
                  <div class="absolute inset-0 flex items-center justify-center">
                    <span class="text-3xl font-bold text-gray-900">17%</span>
                  </div>
                </div>
                <p class="text-sm text-gray-500 mt-2">Target: 0.00%</p>
              </div>
