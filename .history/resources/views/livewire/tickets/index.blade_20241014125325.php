    ...
    <div class="flex space-x-6 w-full max-w-7xl">
        ...
        <div class="w-1/4 bg-white shadow-md rounded-lg p-4">
            ...
            <div class="space-y-4">
                ...
                <div class="border-2 border-green-500 bg-yellow-100 rounded-md p-4"  wire:click="$emit('openModal', 'tickets.more-details', {{ json_encode(['ticket' => $nw->id]) }})">
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between items-center mt-4 text-sm">
                        <button class="flex items-center"><i class="fa fa-folder-open"></i> Open</button>
