        ...
        <div class="w-1/4 bg-white shadow-md rounded-lg p-4">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-yellow-100 p-4 rounded-md">
                    ...
                    <span class="text-sm bg-yellow-400 text-white px-2 py-1 rounded">Ticket ID - #2000{{$nw->title1}}</span>
                    <span class="text-sm  text-white px-2 py-1 ">open{{$nw->title1}}</span>
                    </div>
