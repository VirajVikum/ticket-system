        ...
        <div class="w-1/4 bg-white shadow-md rounded-lg p-4">
            ...
            <div class="relative flex flex-col items-center">
                <svg class="w-32 h-16" viewBox="0 0 100 50">
                    <!-- Background gray arc (always full) -->
                    <path d="M 10,40 A 40,40 0 0,1 90,40" fill="none" stroke="#e5e7eb" stroke-width="10" />
                    <!-- Dynamic black arc (based on percentage) -->
                    <path 
                        d="M 10,40 A 40,40 0 0,1 {{ 10 + (40 / 100) * 80 }},40" 
                        fill="none" 
                        stroke="#111111" 
                        stroke-width="10" 
                ...
                <div class="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center">
                    <span class="text-2xl font-bold text-gray-700">40%</span>
                </div>
            </div>
