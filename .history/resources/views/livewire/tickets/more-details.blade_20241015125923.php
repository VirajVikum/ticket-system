<div class="p-12">
    <div class="p-6 bg-white rounded-lg shadow-md space-y-6">
        <h2 class="text-lg font-semibold">Ticket #200000</h2>
        ...
        <div class="flex justify-between mt-8">
            ...
            <div>
                <button type="button" wire:click="changeStatus" class="text-green-600 hover:text-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Start {{$ticketId}}</button>
