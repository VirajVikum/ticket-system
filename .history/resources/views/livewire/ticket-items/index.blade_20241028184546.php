<div>
    ...
    <button wire:click="openModal({{ $ticketItemId }})" class=" px-2 py-1 rounded">
        <svg class="w-6 h-6 text-blue-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon">
