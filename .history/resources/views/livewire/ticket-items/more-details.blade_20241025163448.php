<div class="justify-center">
    <div class="p-6 bg-white rounded-lg shadow-md space-y-6 text-left"> <!-- Updated: text-left on main container -->
        <h2 class="text-lg font-semibold pl-0">{{$ticketItem->topic}}</h2>
    
        <div class="grid grid-cols-2 gap-6 text-left"> <!-- Updated: text-left on grid container -->
            <div class="justify-between text-left"> <!-- Updated: text-left on each grid item -->
            ...
            <div class="text-left"> <!-- Updated: text-left on second grid item -->
        ...
        <div class="mt-4 text-left"> <!-- Updated: text-left on textarea container -->
            <textarea
        ...
        <div class="space-y-4 mt-6 text-left"> <!-- Updated: text-left on comments container -->
        ...
        <div class="flex justify-between mt-8 text-left"> <!-- Updated: text-left on button container -->
