...
class Index extends Component
{
    ...
    if ($totalTickets > 0) {
        $this->newPrcntg = ($new / $totalTickets) * 100;
        $this->openPrcntg = ($open / $totalTickets) * 100;
        $this->overDuePrcntg = ($overDue / $totalTickets) * 100;
        $this->closedPrcntg = ($closed / $totalTickets) * 100;
    } else {
